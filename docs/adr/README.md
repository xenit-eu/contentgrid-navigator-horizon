...
- [[ADR-018-pagination-cursor-not-url-encoded]]
...
| [018](ADR-018-pagination-cursor-not-url-encoded.md)       | Pagination cursor: local component state, not URL-encoded (amends ADR-001, ADR-005) | Accepted               |
