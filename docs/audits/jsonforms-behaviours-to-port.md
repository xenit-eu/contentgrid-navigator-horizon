...
| JF-2  | `type: ["string", "object"]` union for file fields                                                              | `jsonforms.ts:422`, `Form.tsx:171-173`                 | **Artefact** — JSONForms needs a union to accept both string and File object                                                                                      | **fd-ext**                          | Replace with `FieldDescriptor.type === "file"`; no union needed.                                                     |
