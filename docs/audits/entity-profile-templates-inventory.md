...
### 8.2 Absent property-level constraints in templates

The following `HalFormsPropertyShape` fields are defined by the spec but not set on any property in this dump:

| Field       | Observed? | Note                                                                                                                                                                                                                                                       |
| ----------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `readOnly`  | NO        | System/audit fields (`id`, `audit_metadata`, `created_*`) are simply **omitted** from `create-form` rather than included as `readOnly: true`. The `readOnly` flag exists at the blueprint attribute level but does not surface in profile-level templates. |
| `regex`     | NO        | No pattern constraints expressed in templates.                                                                                                                                                                                                             |
| `minLength` | NO        | —                                                                                                                                                                                                                                                          |
| `maxLength` | NO        | —                                                                                                                                                                                                                                                          |
| `value`     | NO        | No default/pre-filled values in any property.                                                                                                                                                                                                              |
